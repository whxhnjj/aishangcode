...
function kindsTableList($parent_id,$deepID)
{
	...
	printf('<td style="text-align:left;"><div style="width:%dpx;height:20px;background:url(assets/images/bg_kinds.gif) right;float:left;"></div>%s <a style="color:#ccc" href="kinds_new.php?parent_id=%d">[新建子栏目]</a></td>',($deepID*50-40),$name,$id);
