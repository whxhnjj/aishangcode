...
*例子：
    ...
    $tb=new thumb();
    $tb->SetVar("1.jpg","file");
    $tb->Distortion("dis_bei.jpg",150,200);
    $tb->Prorate("pro_bei.jpg",150,200);
    $tb->Cut("cut_bei.jpg",150,200);
    $tb->BackFill("fill_bei.jpg",150,200);
***************************************/
...
class thumb
{
    ...
    function EchoImage($img,$to_File)
    {
        ...
        {
            case "link":
                if(function_exists('imagejpeg')) return ImageJpeg($img,'',95);
                else return ImagePNG($img);
                break;
            case "file":
                if(function_exists('imagejpeg')) return ImageJpeg($img,$to_File,95);
